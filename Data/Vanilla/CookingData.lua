...
-- Cooking recipes for Classic Era: crafting spell ID -> difficulty
-- breakpoints + reagents. Used by ProfessionTips.lua to annotate reagent
-- tooltips with the skill range that still gives points.
--
...
-- Wowhead Classic. Recipe names are comments only - display names come from
...
-- (spices, water, milk, ...). There is never a keep-or-toss decision for
-- these, so the tooltip skips them. Reagents that vendors only stock in
-- limited amounts are deliberately NOT listed.
...
add(2539, 30, 50, 70, 90, { [2672] = 1, [2678] = 1 }) -- Spiced Wolf Meat
...
add(2541, 65, 90, 110, 130, { [2673] = 1 }) -- Coyote Steak
...
add(2546, 110, 120, 140, 160, { [2677] = 1, [2678] = 1 }) -- Dry Pork Ribs
...
add(13028, 175, 215, 235, 255, { [3821] = 1, [159] = 1 }) -- Goldthorn Tea
...
add(15906, 200, 240, 260, 280, { [12037] = 1, [4402] = 1, [2692] = 1 }) -- Dragonbreath Chili
add(15910, 200, 240, 260, 280, { [12204] = 2, [3713] = 1, [159] = 1 }) -- Heavy Kodo Stew
add(21175, 200, 240, 260, 280, { [12205] = 2 }) -- Spider Sausage
add(15915, 225, 265, 285, 305, { [12206] = 1, [2692] = 2 }) -- Spiced Chili Crab
add(15933, 225, 265, 285, 305, { [12207] = 1, [3713] = 2 }) -- Monster Omelet
add(18238, 225, 265, 285, 305, { [4603] = 1 }) -- Spotted Yellowtail
add(18239, 225, 265, 285, 305, { [13754] = 1, [3713] = 1 }) -- Cooked Glossy Mightfish
add(18241, 225, 265, 285, 305, { [13758] = 1 }) -- Filet of Redgill
add(20626, 225, 265, 285, 305, { [7974] = 2, [2692] = 1, [1179] = 1 }) -- Undermine Clam Chowder
add(22480, 225, 265, 285, 305, { [12208] = 1, [3713] = 1 }) -- Tender Wolf Steak
add(18240, 240, 280, 300, 320, { [13755] = 1, [3713] = 1 }) -- Grilled Squid
add(18242, 240, 280, 300, 320, { [13756] = 1, [2692] = 2 }) -- Hot Smoked Bass
add(18243, 250, 290, 310, 330, { [13759] = 1, [159] = 1 }) -- Nightfin Soup
add(18244, 250, 290, 310, 330, { [13760] = 1 }) -- Poached Sunscale Salmon
add(18245, 275, 315, 335, 355, { [13888] = 1, [159] = 1 }) -- Lobster Stew
add(18246, 275, 315, 335, 355, { [13893] = 1, [2692] = 1, [3713] = 1 }) -- Mightfish Steak
add(18247, 275, 315, 335, 355, { [13889] = 1, [3713] = 1 }) -- Baked Salmon
add(22761, 275, 315, 335, 355, { [18255] = 1, [3713] = 1 }) -- Runn Tum Tuber Surprise
add(24801, 285, 325, 345, 365, { [20424] = 1, [3713] = 1 }) -- Smoked Desert Dumplings
add(25659, 300, 325, 345, 365, { [2692] = 1, [9061] = 1, [8150] = 1, [21024] = 1 }) -- Dirge's Kickin' Chimaerok Chops
-- DATA_END
